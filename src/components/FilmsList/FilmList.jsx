...
class FilmsList extends Component {
    ...
    render () {
         if (this.props.isRatedPage && (!this.props.filmData || this.props.filmData.length === 0)) return <Alert  message="Тут пока пусто. Поставь рейтинг фильму" type="info" showIcon={true} banner={true}/>
        else if (this.props.isRatedPage && this.props.filmData.length > 0) return (
